\chapter{Modélisation}
    ...
    \begin{figure}[h]
        \begin{center}
            \includegraphics[scale=0.60]{images/uml/adminPackages.png} 
        \end{center}
    ...
    \begin{figure}[h]
        \begin{center}
            \includegraphics[scale=0.60]{images/uml/adminQuestionsReponses.png} 
        \end{center}
    ...
    \begin{figure}[h]
        \begin{center}
            \includegraphics[scale=0.60]{images/uml/adminRAZ.png} 
        \end{center}
    ...
    \begin{figure}[h]
        \begin{center}
            \includegraphics[scale=0.60]{images/uml/adminSalles.png} 
        \end{center}
    ...
    \begin{figure}[h]
        \begin{center}
            \includegraphics[scale=0.60]{images/uml/adminStats.png} 
        \end{center}
    ...
    \begin{figure}[h]
        \begin{center}
            \includegraphics[scale=0.60]{images/uml/visiteurMenu.png} 
        \end{center}
    ...
    \begin{figure}[h]
        \begin{center}
            \includegraphics[scale= 0.60]{images/uml/etudiantMenuFinal.png} 
        \end{center}
